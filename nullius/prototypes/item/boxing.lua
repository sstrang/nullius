...
create_boxed_item("diesel-canister", "canister", "f")
...
create_boxed_item("geology-pack", "science", "b", nil, "item")
create_boxed_item("climatology-pack", "science", "c", nil, "item")
create_boxed_item("mechanical-pack", "science", "d", nil, "item")
create_boxed_item("electrical-pack", "science", "e", nil, "item")
create_boxed_item("chemical-pack", "science", "f", nil, "item")

create_boxed_item("physics-pack", "science", "g", nil, "item")
...
create_boxed_item("astronomy-pack", "science", "h", nil, "item")
