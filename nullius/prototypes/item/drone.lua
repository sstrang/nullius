...
data:extend({
...

  {
    ...
    rocket_launch_products = {
      {type = "item", name="nullius-guide-drone-iron-1", amount=1, independent_probability = 0.3},
      {type = "item", name="nullius-guide-drone-sandstone-1", amount=1, independent_probability = 0.2},
      {type = "item", name="nullius-guide-drone-bauxite-1", amount=1, independent_probability = 0.2},
      {type = "item", name="nullius-guide-drone-limestone-1", amount=1, independent_probability = 0.1},
      {type = "item", name="nullius-guide-drone-copper-1", amount=1, independent_probability = 0.1},
      {type = "item", name="nullius-guide-drone-uranium-1", amount=1, independent_probability = 0.1}
    }
  },
  {
    type = "recipe",
