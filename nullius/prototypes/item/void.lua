...
for _, recipe in pairs(data.raw.recipe) do
  if (recipe.category == "nullius-liquid-void") or (recipe.categories ~= nil and recipe.categories[1] == "nullius-liquid-void") then
  ...
  elseif (recipe.category == "nullius-gas-void") or (recipe.categories ~= nil and recipe.categories[1] == "nullius-gas-void") then
  ...
  elseif (recipe.category == "turbine-open") or (recipe.categories ~= nil and recipe.categories[1] == "turbine-open") then --or (recipe.categories ~= nil and recipe.categories[1] == "turbine-closed") then 
    if recipe.icons ~= nil then
      local newIcons = table.deepcopy(recipe.icons)
  ...
  elseif (recipe.category == "turbine-closed") or (recipe.categories ~= nil and recipe.categories[1] == "turbine-closed") then 
    if recipe.icons ~= nil then
      local newIcons = table.deepcopy(recipe.icons)
      table.insert(newIcons,{icon = ICONPATH.."fluid/energy.png", scale=0.6, icon_size=32, shift = {-5,5}})
      recipe.icons = newIcons
