...
local function solar_collector(args)
  ...
  return {
    ...
    neighbour_bonus = 0.1,
    -- Factorio 2.1: reactors no longer connect by edge-touching; explicit
    -- neighbour_connectable definitions are required for neighbour_bonus.
    -- Connection points sit on the collision box edges (5 tiles wide, 3 tall).
    neighbour_connectable = {
      connections = {
        { location = { position = { 0,   -1.6 }, direction = defines.direction.north }, category = "nullius-solar-collector", neighbour_category = {"nullius-solar-collector"} },
        { location = { position = { 2.25, 0   }, direction = defines.direction.east  }, category = "nullius-solar-collector", neighbour_category = {"nullius-solar-collector"} },
        { location = { position = { 0,    1.6 }, direction = defines.direction.south }, category = "nullius-solar-collector", neighbour_category = {"nullius-solar-collector"} },
        { location = { position = {-2.25, 0   }, direction = defines.direction.west  }, category = "nullius-solar-collector", neighbour_category = {"nullius-solar-collector"} }
      }
    },
